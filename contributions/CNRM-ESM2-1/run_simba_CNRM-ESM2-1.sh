...
set -euo pipefail
# ================================================================
# run_simba_CNRM-ESM2-1.sh
#
# Description: Run SeaIceMassBudgetAnalysis (SIMBA) to perform a
# sea ice mass budget analysis from the CNRM-ESM2-1 simulations.
#
...
config_file=./configs/CNRM-ESM2-1_esm-up2p0-gwl_config.toml
log_file=./logs/CNRM-ESM2-1_esm-up2p0-gwl_simba.log
